...
export default function FeaturesGrid() {
  ...
  return (
    <section id="features" className="py-8 px-4 sm:px-6 max-w-5xl mx-auto border-t border-black/[0.06]">
      {/* Section header */}
        ...
        {siteConfig.features.map((f) => {
          ...
          return (
            <motion.div
              ...
              className={`rounded-2xl border border-black/[0.08] bg-white shadow-sm p-6 flex flex-col gap-3 cursor-default
          ...
          {SUBJECT_CARDS.map((s) => (
            ...
            >
              <Link href={`/onboard?subject=${s.label.toLowerCase()}`} className="block">
                <div
                  className="rounded-2xl border p-4 flex flex-col gap-2 cursor-pointer transition-all duration-200 hover:brightness-95"
